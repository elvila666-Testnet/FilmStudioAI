 ...
 */
function parseColorPalette(data: any): ColorPalette {
  return {
 ...
 */
function parseColor(data: any): Color {
  return {
    hex: data.hex || "#000000",
 ...
 */
function parseTypography(data: any): Typography {
  return {
 ...
 */
function parseFont(data: any): Font {
  return {
 ...
 */
function parseComposition(data: any): CompositionGuidelines {
  return {
