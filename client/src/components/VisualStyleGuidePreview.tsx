  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 rounded-lg p-6 border border-slate-700">
        <h2 className="text-2xl font-bold text-white mb-2">{styleGuide.brandName}</h2>
        <p className="text-slate-400 mb-4">{styleGuide.moodDescription}</p>
      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
        ...
        <TabsContent value="colors" className="space-y-4">
          ...
          {/* Neutral Colors */}
          {styleGuide.colorPalette.neutral.length > 0 && (
            <div>
        ...
        <TabsContent value="references" className="space-y-4">
          {styleGuide.visualReferences.length > 0 ? (
