...
import { Volume2, Settings, Zap, Trash2 } from "lucide-react";
      ...
      <Tabs defaultValue="mixer" className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="space-y-4">
              ...
              <div className="border-t border-[#404040] pt-4 space-y-4">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    size="sm"
                    className={`flex-1 ${
                      currentTrack.muted ? "bg-red-600 hover:bg-red-700" : ""
                    }`}
                  >
                  ...
                  <Button
                    ...
                    size="sm"
                    className={`flex-1 ${
                      currentTrack.solo ? "bg-yellow-600 hover:bg-yellow-700" : ""
                    }`}
                  >
            ...
            <div className="border-t border-[#404040] pt-4 space-y-2">
              ...
              {localTracks.map((track) => (
                <div
                  key={track.id}
                  className={`p-2 rounded bg-[#3a3a3a] text-xs ${
        ...
        <TabsContent value="eq" className="flex-1 overflow-auto p-4 space-y-4">
          <div className="space-y-2">
            ...
            <Select value={eqMode} onValueChange={(value: any) => setEqMode(value)}>
